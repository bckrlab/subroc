...
NOTEBOOK_PATH="$EXPERIMENT_CODE_PATH/notebooks/misc/find_subgroups_by_size.ipynb"
PARENT_PATH="$(dirname "${BASH_SOURCE[0]}")"
STAGE_NAME="$(basename $PARENT_PATH)"

# list the parameterizations in the stage dir, which define the stage steps
