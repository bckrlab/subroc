...
NOTEBOOK_PATH="$EXPERIMENT_CODE_PATH/notebooks/05_result_presentation/sd_result_set_generalizability_plot_distribution_details.ipynb"
PARENT_PATH="$(dirname "${BASH_SOURCE[0]}")"
STAGE_NAME="$(basename $PARENT_PATH)"

# avoid race conditions when notebooks create this directory
mkdir -p "$STAGE_OUTPUT_PATH/data/processed/uci_mushroom"
